...
local PlayerData = BRCore.Functions.GetPlayerData()
...
local function FormatWeaponAttachments(itemdata)
    ...
    if itemdata.info.attachments ~= nil and next(itemdata.info.attachments) ~= nil then
        for _, v in pairs(itemdata.info.attachments) do
            if exports['br-weapons']:getConfigWeaponAttachments(itemdata.name) then
                for key, value in pairs(exports['br-weapons']:getConfigWeaponAttachments(itemdata.name)) do
                    if value.component == v.component then
                        local item = value.item
                        attachments[#attachments+1] = {
                            attachment = key,
                            label = BRCore.Shared.Items[item].label
                            --label = value.label
                        }
                    end
                end
...
local function OpenTrunk()
    local vehicle = BRCore.Functions.GetClosestVehicle()
...
local function ItemsToItemInfo()
	local itemInfos = {
		[1] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 22x, " ..BRCore.Shared.Items["plastic"]["label"] .. ": 32x."},
		[2] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 30x, " ..BRCore.Shared.Items["plastic"]["label"] .. ": 42x."},
		[3] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 30x, " ..BRCore.Shared.Items["plastic"]["label"] .. ": 45x, "..BRCore.Shared.Items["aluminum"]["label"] .. ": 28x."},
		[4] = {costs = BRCore.Shared.Items["electronickit"]["label"] .. ": 2x, " ..BRCore.Shared.Items["plastic"]["label"] .. ": 52x, "..BRCore.Shared.Items["steel"]["label"] .. ": 40x."},
		[5] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 10x, " ..BRCore.Shared.Items["plastic"]["label"] .. ": 50x, "..BRCore.Shared.Items["aluminum"]["label"] .. ": 30x, "..BRCore.Shared.Items["iron"]["label"] .. ": 17x, "..BRCore.Shared.Items["electronickit"]["label"] .. ": 1x."},
		[6] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 36x, " ..BRCore.Shared.Items["steel"]["label"] .. ": 24x, "..BRCore.Shared.Items["aluminum"]["label"] .. ": 28x."},
		[7] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 32x, " ..BRCore.Shared.Items["steel"]["label"] .. ": 43x, "..BRCore.Shared.Items["plastic"]["label"] .. ": 61x."},
		[8] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 50x, " ..BRCore.Shared.Items["steel"]["label"] .. ": 37x, "..BRCore.Shared.Items["copper"]["label"] .. ": 26x."},
		[9] = {costs = BRCore.Shared.Items["iron"]["label"] .. ": 60x, " ..BRCore.Shared.Items["glass"]["label"] .. ": 30x."},
		[10] = {costs = BRCore.Shared.Items["aluminum"]["label"] .. ": 60x, " ..BRCore.Shared.Items["glass"]["label"] .. ": 30x."},
		[11] = {costs = BRCore.Shared.Items["iron"]["label"] .. ": 33x, " ..BRCore.Shared.Items["steel"]["label"] .. ": 44x, "..BRCore.Shared.Items["plastic"]["label"] .. ": 55x, "..BRCore.Shared.Items["aluminum"]["label"] .. ": 22x."},
		[12] = {costs = BRCore.Shared.Items["iron"]["label"] .. ": 50x, " ..BRCore.Shared.Items["steel"]["label"] .. ": 50x, "..BRCore.Shared.Items["screwdriverset"]["label"] .. ": 3x, "..BRCore.Shared.Items["advancedlockpick"]["label"] .. ": 2x."},
	}
...
local function SetupAttachmentItemsInfo()
	local itemInfos = {
		[1] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 140x, " .. BRCore.Shared.Items["steel"]["label"] .. ": 250x, " .. BRCore.Shared.Items["rubber"]["label"] .. ": 60x"},
		[2] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 165x, " .. BRCore.Shared.Items["steel"]["label"] .. ": 285x, " .. BRCore.Shared.Items["rubber"]["label"] .. ": 75x"},
		[3] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 190x, " .. BRCore.Shared.Items["steel"]["label"] .. ": 305x, " .. BRCore.Shared.Items["rubber"]["label"] .. ": 85x, " .. BRCore.Shared.Items["smg_extendedclip"]["label"] .. ": 1x"},
		[4] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 205x, " .. BRCore.Shared.Items["steel"]["label"] .. ": 340x, " .. BRCore.Shared.Items["rubber"]["label"] .. ": 110x, " .. BRCore.Shared.Items["smg_extendedclip"]["label"] .. ": 2x"},
		[5] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 230x, " .. BRCore.Shared.Items["steel"]["label"] .. ": 365x, " .. BRCore.Shared.Items["rubber"]["label"] .. ": 130x"},
		[6] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 255x, " .. BRCore.Shared.Items["steel"]["label"] .. ": 390x, " .. BRCore.Shared.Items["rubber"]["label"] .. ": 145x"},
		[7] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 270x, " .. BRCore.Shared.Items["steel"]["label"] .. ": 435x, " .. BRCore.Shared.Items["rubber"]["label"] .. ": 155x"},
		[8] = {costs = BRCore.Shared.Items["metalscrap"]["label"] .. ": 300x, " .. BRCore.Shared.Items["steel"]["label"] .. ": 469x, " .. BRCore.Shared.Items["rubber"]["label"] .. ": 170x"},
	}
...
local function CreateItemDrop(index)
	...
	if Config.UseTarget then
		exports['br-target']:AddTargetEntity(dropItem, {
			options = {
				{
...
-- RegisterNetEvent('GetCashClient', function(cash)
--     playercash = cash
-- end)
...
RegisterNetEvent('BRCore:Client:OnPlayerLoaded', function()
    LocalPlayer.state:set("inv_busy", false, true)
    PlayerData = BRCore.Functions.GetPlayerData()
    BRCore.Functions.TriggerCallback("inventory:server:GetCurrentDrops", function(theDrops)
		Drops = theDrops
    end)
end)

RegisterNetEvent('BRCore:Client:OnPlayerUnload', function()
    LocalPlayer.state:set("inv_busy", true, true)
    PlayerData = {}
    RemoveAllNearbyDrops()
end)

RegisterNetEvent('BRCore:Client:UpdateObject', function()
    BRCore = exports['br-core']:GetCoreObject()
end)

RegisterNetEvent('BRCore:Player:SetPlayerData', function(val)
    PlayerData = val
end)
...
RegisterNetEvent("br-inventory:client:closeinv", function()
    closeInventory()
end)

RegisterNetEvent('inventory:client:CheckOpenState', function(type, id, label)
    local name = BRCore.Shared.SplitStr(label, "-")[2]
    if type == "stash" then
    ...
    if bool then
        for k in pairs(items) do
            itemTable[#itemTable+1] = {
                item = items[k].name,
                label = BRCore.Shared.Items[items[k].name]["label"],
                image = items[k].image,
            }
        end
    end
...
RegisterNetEvent('inventory:client:OpenInventory', function(PlayerAmmo, inventory, other)
    if not IsEntityDead(PlayerPedId()) then
        ...
        SendNUIMessage({
            ...
            other = other,
            maxweight = BRCore.Config.Player.MaxWeight,
            Ammo = PlayerAmmo,
...
RegisterNetEvent('inventory:client:CraftItems', function(itemName, itemCosts, amount, toSlot, points)
    ...
    isCrafting = true
    BRCore.Functions.Progressbar("repair_vehicle", Lang:t("progress.crafting"), (math.random(2000, 5000) * amount), false, true, {
	    ...
	    StopAnimTask(ped, "mini@repair", "fixing_a_player", 1.0)
            ...
            TriggerEvent('inventory:client:ItemBox', BRCore.Shared.Items[itemName], 'add')
            isCrafting = false
	end, function() -- Cancel
	    StopAnimTask(ped, "mini@repair", "fixing_a_player", 1.0)
            BRCore.Functions.Notify(Lang:t("notify.failed"), "error")
            isCrafting = false
	end)
end)
...
RegisterNetEvent('inventory:client:PickupSnowballs', function()
    ...
    BRCore.Functions.Progressbar("pickupsnowball", Lang:t("progress.snowballs"), 1500, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
	...
	TriggerServerEvent('inventory:server:snowball', 'add')
        TriggerEvent('inventory:client:ItemBox', BRCore.Shared.Items["snowball"], "add")
    end, function() -- Cancel
        ClearPedTasks(ped)
        BRCore.Functions.Notify(Lang:t("notify.canceled"), "error")
    end)
end)
...
RegisterNetEvent('inventory:client:UseWeapon', function(weaponData, shootbool)
    ...
    if currentWeapon == weaponName then
        ...
        currentWeapon = nil
    elseif weaponName == "weapon_stickybomb" or weaponName == "weapon_pipebomb" or weaponName == "weapon_smokegrenade" or weaponName == "weapon_flare" or weaponName == "weapon_flashbang" or weaponName == "weapon_ball"  or weaponName == "weapon_molotov" or weaponName == "weapon_grenade" or weaponName == "weapon_bzgas" then
...
RegisterNetEvent('br-inventory:client:giveAnim', function()
    ...
    if not isCrafting and not inInventory then
        if not PlayerData.metadata["isdead"] and not PlayerData.metadata["inlaststand"] and not PlayerData.metadata["ishandcuffed"] and not IsPauseMenuActive() then
            ...
            if IsPedInAnyVehicle(ped, false) then -- Is Player In Vehicle
                ...
                CurrentGlovebox = BRCore.Functions.GetPlate(vehicle)
                curVeh = vehicle
                CurrentVehicle = nil
            else
                local vehicle = BRCore.Functions.GetClosestVehicle()
		    ...
		    local trunkpos = GetOffsetFromEntityInWorldCoords(vehicle, 0.0, (dimensionMin.y), 0.0)
                    ...
                    if #(pos - trunkpos) < 1.5 and not IsPedInAnyVehicle(ped) then
                        if GetVehicleDoorLockStatus(vehicle) < 2 then
                            CurrentVehicle = BRCore.Functions.GetPlate(vehicle)
                            curVeh = vehicle
                            CurrentGlovebox = nil
                        else
                            BRCore.Functions.Notify(Lang:t("notify.vlocked"), "error")
                            return
                        end
                    else
                        CurrentVehicle = nil
...
RegisterNUICallback('Notify', function(data, cb)
    BRCore.Functions.Notify(data.message, data.type)
    cb('ok')
end)

RegisterNUICallback('GetWeaponData', function(cData, cb)
    local data = {
        WeaponData = BRCore.Shared.Items[cData.weapon],
...
RegisterNUICallback('RemoveAttachment', function(data, cb)
    local ped = PlayerPedId()
    local WeaponData = BRCore.Shared.Items[data.WeaponData.name]
    local Attachment = exports['br-weapons']:getConfigWeaponAttachments(WeaponData.name:upper())[data.AttachmentData.attachment]
    BRCore.Functions.TriggerCallback('weapons:server:RemoveAttachment', function(NewAttachments)
        if NewAttachments ~= false then
            ...
            for _, v in pairs(NewAttachments) do
                for _, pew in pairs(exports['br-weapons']:getConfigWeaponAttachments(WeaponData.name:upper())) do
...
RegisterNUICallback('getCombineItem', function(data, cb)
    cb(BRCore.Shared.Items[data.item])
end)
...
RegisterNUICallback('showBlur', function(data)
    if data.blur then
        blur = true
...
RegisterNUICallback('combineWithAnim', function(data, cb)
    ...
    BRCore.Functions.Progressbar("combine_anim", animText, animTimeout, false, true, {
...
RegisterNUICallback("GiveItem", function(data, cb)
    local player, distance = BRCore.Functions.GetClosestPlayer(GetEntityCoords(PlayerPedId()))
    if player ~= -1 and distance < 3 then
        if data.inventory == 'player' then
            ...
            BRCore.Functions.Notify(Lang:t("notify.notowned"), "error")
        end
    else
        BRCore.Functions.Notify(Lang:t("notify.nonb"), "error")
    end
    cb('ok')
end)
...
-- CreateThread(function()
--     if Config.UseTarget then
--         exports['br-target']:AddTargetModel(Config.VendingObjects, {
--             options = {
--                 {
...
-- CreateThread(function()
--     if Config.UseTarget then
--         exports['br-target']:AddTargetModel(Config.CraftingObject, {
--             options = {
--                 {
